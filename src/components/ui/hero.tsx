...
export default function HeroSectionOne() {
  return (
    <div
      className="relative flex min-h-screen flex-col items-center justify-center bg-cover bg-center bg-no-repeat py-20 pt-32"
    ...
    >
      ...
      <div className="container relative px-4 flex-1 flex items-center">
        ...
        >
          ...
          >
            With AGS, you can get your loan in time. Contact our best in class
            team to get your loan approved effortlessly.
          </motion.p>
          ...
          >
            <Button
              asChild
              size="lg"
              className="gap-2 text-lg bg-green-600 hover:bg-green-700 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
            >
