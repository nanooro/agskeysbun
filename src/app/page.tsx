...
const features = [
  {
    ...
    description: '256-bit SSL encryption protects all your financial data and transactions with military-grade security protocols.',
    details: ['End-to-end encryption', 'PCI DSS compliant', 'Regular security audits']
  },
  {
    icon: Clock,
    title: 'Lightning Fast Approval',
    description: 'Get loan approval in as little as 24 hours with our AI-powered application processing system.',
    details: ['24-hour processing', 'Real-time status updates', 'Instant pre-approval']
  },
  {
    icon: Users,
    title: 'Expert Financial Advisors',
    description: 'Certified financial experts guide you through every step, ensuring you get the best loan for your needs.',
    details: ['Personal consultation', 'Custom loan structuring', 'Ongoing support']
  },
  {
    icon: Award,
    title: 'Industry Best Rates',
    description: 'Competitive interest rates starting from 8.4% with flexible repayment options tailored to your budget.',
    details: ['Starting from 8.4%', 'No hidden fees', 'Flexible EMI options']
  },
  {
    icon: Headphones,
    title: '24/7 Premium Support',
    description: 'Round-the-clock customer service via phone, email, live chat, and WhatsApp for immediate assistance.',
    details: ['24/7 availability', 'Multi-channel support', 'Average 2min response time']
  },
  {
    icon: CheckCircle,
    title: '100% Digital Process',
    description: 'Complete your entire loan application online with minimal documentation and instant disbursal.',
    details: ['Paperless application', 'Digital signatures', 'Instant disbursal']
  }
];
...
const testimonials = [
  {
    ...
    content: "AGS helped me expand my boutique when I needed it most. The process was incredibly smooth and the rates were unbeatable!",
    rating: 5,
    avatar: "PS"
  },
  {
    ...
    content: "Got my personal loan approved in just 18 hours! The team was professional and guided me through every step.",
    rating: 5,
    avatar: "RK"
  },
  {
    ...
    content: "The business loan helped me renovate my restaurant. Excellent service and very competitive interest rates.",
    rating: 5,
    avatar: "AP"
  }
];
...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* Features Section */}
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-900 dark:to-neutral-800">
        <div className="max-w-7xl mx-auto">
                ...
                <div className="space-y-2">
                  {feature.details.map((detail, detailIndex) => (
                    <div key={detailIndex} className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-neutral-500 dark:text-neutral-400">{detail}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-green-600 px-8 py-4 text-lg font-semibold">
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-neutral-300 max-w-3xl mx-auto">
                Getting a loan with AGS is simple, fast, and transparent. Here's how it works in 3 easy steps.
              </p>
            </motion.div>
              ...
              {[
                {
                  step: "01",
                  title: "Apply Online",
                  description: "Fill out our simple online application form in just 5 minutes. No complex paperwork required.",
                  icon: Lightbulb,
                  color: "bg-blue-500"
                },
                {
                  step: "02",
                  title: "Get Approved",
                  description: "Our AI system reviews your application and you get approval within 24 hours with competitive rates.",
                  icon: Rocket,
                  color: "bg-green-500"
                },
                {
                  step: "03",
                  title: "Receive Funds",
                  description: "Once approved, funds are disbursed directly to your account within 2-3 business days.",
                  icon: Target,
                  color: "bg-purple-500"
                }
              ].map((item, index) => (
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-neutral-900 dark:bg-black">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-neutral-300 max-w-3xl mx-auto">
              Our track record speaks for itself. Here's what we've achieved together with our customers.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-neutral-300 max-w-3xl mx-auto">
                Don't just take our word for it. Here's what real customers have to say about their experience with AGS.
              </p>
            </motion.div>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-900 dark:to-neutral-800">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-xl text-neutral-600 dark:text-neutral-300 max-w-3xl mx-auto mb-8">
              Choose the perfect plan for your financial needs. All pricing is transparent with no hidden charges.
            </p>
          </motion.div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {[
                    ...
                    <tr key={index} className="border-b border-neutral-100 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-700/50 transition-colors">
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-lg text-neutral-600 dark:text-neutral-300">
                  Have questions? Need help with your application? We're here to help!
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-3">
                      Full Name *
                    </label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="phone" className="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-3">
                      Phone Number
                    </label>
                    <input
                      type="tel"
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-3">
                      Subject *
                    </label>
                    <select
                      id="subject"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-3">
                    Message *
                  </label>
                  <textarea
                    id="message"
            ...
            >
              <div>
                ...
                <p className="text-lg text-neutral-300 mb-8">
                  Reach out through any channel. We're available 24/7 to assist you!
                </p>
              </div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {info.details.map((detail, detailIndex) => (
                        <p key={detailIndex} className="text-neutral-300 font-medium">
                          {detail}
                        </p>
                      ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-neutral-300 mb-6 max-w-md">
                Your trusted partner for financial solutions. We provide fast, secure, and transparent loan services across India.
              </p>
              <div className="flex gap-4">
                <Link href="tel:+91801234567" className="bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors font-medium">
                  Call Now
                </Link>
                <button
            ...
            <div>
              ...
              <ul className="space-y-2 text-neutral-300">
                <li><button onClick={() => scrollToSection('#loans')} className="hover:text-green-500 transition-colors text-left">Personal Loans</button></li>
                <li><button onClick={() => scrollToSection('#loans')} className="hover:text-green-500 transition-colors text-left">Business Loans</button></li>
                <li><button onClick={() => scrollToSection('#loans')} className="hover:text-green-500 transition-colors text-left">Home Loans</button></li>
                <li><button onClick={() => scrollToSection('#loans')} className="hover:text-green-500 transition-colors text-left">Vehicle Loans</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-neutral-300">
                <li><button onClick={() => scrollToSection('#features')} className="hover:text-green-500 transition-colors text-left">About Us</button></li>
                <li><button onClick={() => scrollToSection('#contact')} className="hover:text-green-500 transition-colors text-left">Contact</button></li>
                <li><button onClick={() => scrollToSection('#pricing')} className="hover:text-green-500 transition-colors text-left">Pricing</button></li>
                <li><button onClick={() => scrollToSection('#contact')} className="hover:text-green-500 transition-colors text-left">Support</button></li>
              </ul>
            </div>
          </div>

          <div className="border-t border-neutral-800 mt-8 pt-8 text-center text-neutral-400">
            <p>&copy; 2025 AGS Financial Services. All rights reserved. | Licensed financial services provider.</p>
          </div>
        </div>
      </footer>
    </motion.div>
